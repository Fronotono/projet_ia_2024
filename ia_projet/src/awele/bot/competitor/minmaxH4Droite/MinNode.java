...
public class MinNode extends MinMaxNode
{
     ...
     */
    MinNode (Board board,int realDepth)
    {
     ...
     */
    MinNode (Board board, int depth, double alpha, double beta,int realDepth)
    {
    ...
    {
        return new MaxNode (board, depth, alpha, beta, realDepth);
    }
