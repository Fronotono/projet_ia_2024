...
public abstract class MinMaxNode
{
    ...
    {
    	if(board.getLog(player).length == 0)decision = new double []{0,0,0,0,0,1};
    	else {
    ...
    private int heuristique (Board board)
    {
        ...
        return board.getScore (MinMaxNode.player) - board.getScore (Board.otherPlayer (MinMaxNode.player)) * 30;// + 28*krou - 36*uselessHole - 54*dangerousHole-28*krou + 36*uselessHole + 54 *dangerousHole
