...
public class Individu implements Comparable<Individu>{
	...
	int fitness; //score de l'individu
	int[] poids; //reprensente les gènes de l'individu
	...
	/*Creation d'un individu heritant aléatoirement des genes de papa et maman avec une mutation potentiel*/
	...
	/*genere un entier aleatoire en min et max inclus*/
    private int random(int min, int max) {
    	return min+new Random().nextInt(max-min)+1;
    }

    /*fonction utilisé par le Array.sort()*/
	@Override
